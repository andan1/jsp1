...
public class BoardDAO {
	...
	// BoardUpdate, Delete용 하나의 게시글을 리턴하는 메소드
	...
	// update와 delete 시 필요한 패스워드값을 리턴해 주는 메소드
